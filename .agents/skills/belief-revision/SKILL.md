...
- **Rule 8a** (quantified effect discipline) — New evidence expressed as an effect size carries its denominator and absolute effect before it can move a load-bearing claim. A dramatic relative figure is the most common way thin evidence looks decisive.
- **Rule 8c** (causal direction burden) — New evidence asserting causation states its direction status. Evidence that establishes association where the prior required causation refines the prior; it does not overturn it.
